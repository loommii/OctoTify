...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/octotify_internal_handler_dto.PingResp"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "octotify_internal_handler_dto.PingResp": {
            "type": "object",
            "properties": {
                "server_name": {
                    "description": "服务名称",
                ...
                "server_time": {
                    "description": "服务器时间，格式：YYYY-MM-DD HH:MM:SS",
                    "type": "string"
                },
                "timestamp": {
