...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "OctoTify API Support",
            "url": "https://github.com/OctoTify"
        },
        "license": {
            "name": "MIT",
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.StartBindResp"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.GetBindStatusReq"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.BindStatusResp"
                                        }
                                    }
                                }
                            ]
        ...
        "dto.BindStatusResp": {
            ...
            "properties": {
                "credentials": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.BindCredentialsDTO"
                        }
                    ]
                },
                "status": {
        ...
        "dto.ChannelDTO": {
            ...
            "properties": {
                "config": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.ChannelConfig"
                        }
                    ]
                },
                "created_at_ts": {
    ...
    "tags": [
        {
            "description": "用户登录、退出登录、刷新令牌等认证相关接口",
            "name": "用户认证"
        },
        {
            "description": "用户注册、修改密码、查询用户信息等管理接口",
            "name": "用户管理"
        },
        {
            "description": "创建、编辑、删除消息来源，管理来源令牌等接口",
            "name": "消息来源管理"
        },
        {
            "description": "创建、编辑、删除推送渠道，测试渠道连接等接口",
            "name": "推送渠道管理"
        },
        {
            "description": "查询消息列表、筛选消息、查看消息详情、删除消息等接口",
            "name": "消息管理"
        },
        {
