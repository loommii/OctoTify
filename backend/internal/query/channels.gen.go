...
func newChannel(db *gorm.DB, opts ...gen.DOOption) channel {
	...
	_channel.UserID = field.NewInt64(tableName, "user_id")
	_channel.Type = field.NewString(tableName, "type")
	_channel.Name = field.NewString(tableName, "name")
	_channel.Config = field.NewField(tableName, "config")
	_channel.Status = field.NewInt(tableName, "status")
	_channel.CreatedAt = field.NewTime(tableName, "created_at")
	_channel.UpdatedAt = field.NewTime(tableName, "updated_at")
	_channel.LastUsedAt = field.NewTime(tableName, "last_used_at")
...
func (c *channel) updateTableName(table string) *channel {
	...
	c.LastUsedAt = field.NewTime(table, "last_used_at")
