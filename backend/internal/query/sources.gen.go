...
func newSource(db *gorm.DB, opts ...gen.DOOption) source {
	...
	_source.ID = field.NewInt64(tableName, "id")
	_source.UserID = field.NewInt64(tableName, "user_id")
	_source.Name = field.NewString(tableName, "name")
	_source.Token = field.NewString(tableName, "token")
	_source.Description = field.NewString(tableName, "description")
	_source.Status = field.NewInt(tableName, "status")
	_source.CreatedAt = field.NewTime(tableName, "created_at")
	_source.UpdatedAt = field.NewTime(tableName, "updated_at")
	_source.LastUsedAt = field.NewTime(tableName, "last_used_at")
